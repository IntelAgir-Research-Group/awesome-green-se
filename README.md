...
| BMC (Dell only)    | iDRAC                          | Embedded controller in Dell PowerEdge servers for out-of-band power monitoring; tracks cumulative, peak, and average power consumption via web UI.                                                                    | [Link](https://www.dell.com/support/kbdoc/en-us/000391164/poweredge-how-to-monitor-server-health-from-the-idrac9) |
| BMC (Multi-vendor) | IPMI                           | Vendor-neutral out-of-band interface for server power monitoring via `ipmitool`; works on most Intel and AMD server-class hardware from Dell, HP, Lenovo, Supermicro, and others. Not supported on ARM or FPGA nodes. | [Link](https://www.manageengine.com/network-monitoring/ipmi-monitoring.html)                                      |
